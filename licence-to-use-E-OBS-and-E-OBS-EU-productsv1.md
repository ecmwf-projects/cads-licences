# E-OBS and E-OBS_EU product licences

This catalogue entry distributes **two products under two different licences**. To download any data from this entry you must accept this licence. **The terms that apply to you depend on which product you download:**

- **E-OBS** — the dataset covering the **whole of Europe** — is governed by the **E-OBS product licence** (Section 1 below). These data are strictly for use in non-commercial research and education projects only.
- **E-OBS_EU** — the subset covering the **EU area plus Norway, Switzerland, Iceland and the United Kingdom** — is governed by the **Creative Commons Attribution 4.0 International (CC-BY 4.0)** licence (Section 2 below). These data may be used for any purpose, including commercial use, provided appropriate attribution is given.

Each licence applies **only to its respective product**. Accepting this combined licence does not extend the restrictions of the E-OBS product licence to the E-OBS_EU product, nor the other way around.

---

## Section 1 — E-OBS product (whole of Europe)
...
## Section 2 — E-OBS_EU product (EU area plus Norway, Switzerland, Iceland and the United Kingdom)

The E-OBS_EU product is released for use under the **Creative Commons Attribution 4.0 International (CC-BY 4.0)** licence.
