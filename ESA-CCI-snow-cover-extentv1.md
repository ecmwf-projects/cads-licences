**Snow CCI dataset licence**

**Terms and Conditions for use of Snow CCI datasets from the CCI Open Data Portal**
...
1) Users of the CCI data are required to acknowledge the ESA Climate Change Initiative and the Snow CCI project together with the individual data providers if the data are used in a presentation or publication. Please also cite the dataset paper and the relevant dataset (see text below).
