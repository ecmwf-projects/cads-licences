...
-   [ECMWF does not accept any liability whatsoever for any error or
    ...
    arising from their use.]{lang="EN-US"}
-   [ECMWF makes no warranty as to the accuracy or completeness of its
    data products [or  the]{.GramE} uninterrupted provision of such data
    ...
    fullest extent]{.GramE} permissible by law.]{lang="EN-US"}
-   [ECMWF shall not be liable should ECMWF discontinue the provision of
    its data products at any time.]{lang="EN-US"}
-   [ECMWF shall have no liability in contract, tort or otherwise
    arising out of or in connection with these Terms of
    Use.]{lang="EN-US"}
-   [Users must remove attribution if requested by ECMWF.]{lang="EN-US"}
-   [These Terms of Use shall be governed by and construed in accordance
    with the [laws  of]{.GramE} England and Wales.]{lang="EN-US"}
-   [The parties shall attempt to settle any dispute between them in
    ...
    appointed in accordance with the said [rules;]{.GramE} sitting in
    ...
    question of law arising [in the course of]{.GramE} any arbitral
    proceedings or out of an award made in any arbitral proceedings is
    hereby agreed to be excluded.]{lang="EN-US"}
...
-   [Access to the data products and services may be unavailable,
    ...
    unavailability, delay or interruption in access.]{lang="EN-US"}
...
[licence]{.SpellE},
visit <https://creativecommons.org/licenses/by-nc/4.0/legalcode>]{lang="EN-US"}

[You are free to:]{lang="EN-US"}
...
[Under the following terms:]{lang="EN-US"}

-   [You must give appropriate credit (attribution) to ECMWF as outlined
    below, provide a link to the [licence]{.SpellE}, and indicate if
    changes were made.]{lang="EN-US"}
-   [Non-Commercial --- You may not use the material for [commercial
    purposes](https://creativecommons.org/licenses/by-nc/4.0/).]{lang="EN-US"}
...
[The following additional conditions apply: ]{lang="EN-US"}

1.  [Research is understood as any project [organised]{.SpellE} by a
...
2.  [Although every care has been taken in preparing and testing the
    ...
    arising from its use.]{lang="EN-US"}
3.  [The Licensee agrees to acknowledge the origin of the Products in
    ...
    [Programme]{.SpellE} (WWRP) and the World Climate Research
    [Programme]{.SpellE} (WCRP). The original S2S database is hosted at
    ...
    For dataset source, please cite: [Vitart]{.SpellE} [et
    [al.,The]{.SpellE}]{.GramE} Sub-seasonal to Seasonal (S2S)
    Prediction Project Database. Bull. Amer. Meteor. Soc., 98(1),
    163-176.
    [doi]{.SpellE}: <http://dx.doi.org/10.1175/BAMS-D-16-0017.1>.]{lang="EN-US"}
4.  [Any person extracting data from this server will accept
    responsibility for informing all data users of these
    conditions.]{lang="EN-US"}

[The following wording shall be attached to the use of this ECMWF data
product, in addition to acknowledging S2S: ]{lang="EN-US"}

-   [Copyright statement: Copyright \"© \[year\] European Centre for
    Medium-Range Weather Forecasts (ECMWF)\".]{lang="EN-US"}
-   [Source [https://apps.ecmwf.int/datasets/](https://apps-test.ecmwf.int/datasets/)]{lang="EN-US"}
-   [[Licence]{lang="EN-US"}]{.SpellE}[ Statement: This data is
    published under a Creative Commons Attribution Non-Commercial
    4.0 International (CC BY NC
    4.0). <https://creativecommons.org/licenses/by-nc/4.0/legalcode>]{lang="EN-US"}
-   [Disclaimer: ECMWF does not accept any liability whatsoever for any
    ...
    or damage arising from their use.]{lang="EN-US"}
-   [Where applicable, an indication if the material has been modified
    and an indication of previous modifications.]{lang="EN-US"}
...
-   [Copyright statement: Copyright \"This service is based on data and
    ...
    (ECMWF)\".]{lang="EN-US"}
-   [Source [https://apps.ecmwf.int/datasets/](https://apps-test.ecmwf.int/datasets/)]{lang="EN-US"}
-   [[Licence]{lang="EN-US"}]{.SpellE}[ Statement: This ECMWF data is
...
words used below shall mean:]{lang="EN-US"}

-   [[**[Products:]{lang="EN-US"}**[The]{lang="EN-US"}]{.GramE}]{.SpellE}[
    items of the Sub-seasonal To Seasonal (S2S) dataset.]{lang="EN-US"}
-   [[**[ECMWF:]{lang="EN-US"}**[The]{lang="EN-US"}]{.GramE}]{.SpellE}[
    European Centre For Medium-Range Weather Forecasts (ECMWF) whose
    principal place of business is at [Shinfield]{.SpellE} Park,
    Reading, RG2 9AX, United Kingdom.]{lang="EN-US"}
-   **[Direct/Batch Access]{lang="EN-US"}**[: Access to the ECMWF
    systems by means of an interactive client software which allows the
    Licensee to retrieve Products.]{lang="EN-US"}
-   [[**[Licensee:]{lang="EN-US"}**[The]{lang="EN-US"}]{.GramE}]{.SpellE}[
    person or the [organisation]{.SpellE} he/she represents, whose
    details are contained in this registration form,
    [authorised]{.SpellE} by the Licensor to use the
    Products.]{lang="EN-US"}
-   **[Licensor:]{lang="EN-US"}**[ ECMWF and its own
    licensors.]{lang="EN-US"}
-   **[Third Party Users: ]{lang="EN-US"}**[users who are
    [authorised]{.SpellE} by the Licensee to access and use the Products
    subject to them registering
    at: <http://apps.ecmwf.int/datasets/data/s2s/licence>]{lang="EN-US"}

**[Conditions]{lang="EN-US"}**

1.  [The Licensee is [authorised]{.SpellE} to use on a non-exclusive
    basis the Products exclusively for non-commercial research and
    educational purposes.]{lang="EN-US"}
...
3.  [Except as provided in Condition 5 hereinafter, the Licensee shall
    ...
    Products can be accurately rebuilt [from the service,]{.GramE} to
...
4.  [The most complete and up-to-date version of the Products is hosted
    ...
    Products or for any other purposes.]{lang="EN-US"}
...
-   [require the [Third Party]{.GramE} User to register
    at <http://apps.ecmwf.int/datasets/data/s2s/licence>]{lang="EN-US"}
-   [restrict the [Third Party]{.GramE} User's use of the Products to
    non-commercial research and education, as defined in these
    [Licence]{.SpellE} Terms; and]{lang="EN-US"}
-   [inform the [Third Party]{.GramE} User about any processing to the
    Products (e.g. interpolation) applied by the Licensee since
    receiving them from the Licensor.]{lang="EN-US"}

```{=html}
<!-- -->
```
-   [The Licensee shall notify the Licensor if it becomes aware of any
    [unauthorised]{.SpellE} use of the Products including by Third Party
    Users. If the Licensee becomes aware of any [Third Party]{.GramE}
    User breaching these [Licence]{.SpellE} Terms, the Licensee shall
    terminate immediately such Third Party User's access to the
    Products.]{lang="EN-US"}
-   [Supply by the Licensee of the Products in breach of this
    [Licence]{.SpellE} Terms including supply to Third Party Users who
    then make [unauthorised]{.SpellE} use of the Products shall be
    considered as a default of the Licensee and shall render the
    Licensee liable vis-à-vis the Licensor and shall lead[, in
    particular, to]{.GramE} the application of Condition 12
    hereinafter.]{lang="EN-US"}
-   [All Intellectual Property Rights of the Products owned by
    [ECMWF]{.GramE} or its licensors shall remain the property of ECMWF
...
-   [The Licensor makes no warranty as to the accuracy or completeness
    ...
    from this agreement to the fullest extent]{.GramE} permissible by
    law.]{lang="EN-US"}
-   [Neither party shall be liable to the other under any cause of
    ...
    possibility of such loss.]{lang="EN-US"}
-   [The Licensor may terminate this [Licence]{.SpellE} if the Licensee
    ...
    to remedy such breach.]{lang="EN-US"}
